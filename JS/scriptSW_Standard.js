...
function startGame(){
    ...
    sun = new MakeSun(450,465,15,"#fcf31c","miter");
    sun2 = new MakeSun(450,465,25,"#fcf31c","miter");
    earthShip = new Spaceship(75,300,100,300,80,295,60,290,70,300,60,310,80,305,100,300,"#0014ff","miter",true,0,1);
    alienShip = new Spaceship(785,630,760,630,780,628,800,620,805,630,800,640,780,632,760,630,"#f24404","round",true,0,-1);
...
function updateGameArea(){
    ...
    //----------------------
    if ((earthShip.active) && (gameArea.keys) && (gameArea.keys[87]) && ((earthShip.x > 10) && (earthShip.x < 890) && (earthShip.y > 10) && (earthShip.y < 920)) ){
        thrustSound.play();
    ...
    if ((earthShip.active) && (gameArea.keys) && (gameArea.keys[83]) && ((earthShip.x > 10) && (earthShip.x < 890) && (earthShip.y > 10) && (earthShip.y < 920))){
        thrustSound.play();
        motion1(earthShip,aFactorE);
        aFactorE *= 1.0;
        earthShipAngle = earthShip.angle;
    ...
    if ((earthShip.active) && (gameArea.keys) && (gameArea.keys[88]) && ((earthShip.x > 10) && (earthShip.x < 890) && (earthShip.y > 10) && (earthShip.y < 920))){
        thrustSound.play();
        motion1(earthShip,aFactorE);
        aFactorE *= 0.99;
        earthShipAngle = earthShip.angle;
    ...
    if ((alienShip.active) && (gameArea.keys) && (gameArea.keys[79]) && ((alienShip.x > 10) && (alienShip.x < 890) && (alienShip.y > 10) && (alienShip.y < 920))){
        thrustSound.play();
    ...
    if ((alienShip.active) && (gameArea.keys) && (gameArea.keys[76]) && ((alienShip.x > 10) && (alienShip.x < 890) && (alienShip.y > 10) && (alienShip.y < 920))){
        thrustSound.play();
        motion1(alienShip,aFactorA);
        aFactorA *= 1.0;
        alienShipAngle = alienShip.angle;
    ...
    if ((alienShip.active) && (gameArea.keys) && (gameArea.keys[190]) && ((alienShip.x > 10) && (alienShip.x < 890) && (alienShip.y > 10) && (alienShip.y < 920))){
        thrustSound.play();
        motion1(alienShip,aFactorA);
        aFactorA *= 0.99;
        alienShipAngle = alienShip.angle;
