...
var aFactor = 1.5;                  // factor used to increase/decrease ship rate of travel
var aFactorE = 1.5;                 //earthShip acceleration factor
var aFactorA = 1.5;                 //alienShip acceleration factor
...
function startGame(){
    ...
    sun = new MakeSun(700,400,15,"#fcf31c","miter");
    sun2 = new MakeSun(700,400,25,"#fcf31c","miter");
    earthShip = new Spaceship(75,200,100,200,80,195,60,190,70,200,60,210,80,205,100,200,"#0014ff","miter",true,0,1);
    alienShip = new Spaceship(1285,600,1260,600,1280,598,1300,590,1305,600,1300,610,1280,602,1260,600,"#f24404","round",true,0,-1);
...
function updateGameArea(){
    ...
    //----------------------
    if ((earthShip.active) && (gameArea.keys) && (gameArea.keys[87]) && ((earthShip.x > 10) && (earthShip.x < 1390) && (earthShip.y > 10) && (earthShip.y < 790)) ){
        thrustSound.play();
    ...
    if ((earthShip.active) && (gameArea.keys) && (gameArea.keys[83]) && ((earthShip.x > 10) && (earthShip.x < 1390) && (earthShip.y > 10) && (earthShip.y < 790))){
        thrustSound.play();
        motion1(earthShip,aFactorE);
        aFactorE *= 1.0;
        earthShipAngle = earthShip.angle;
    ...
    if ((earthShip.active) && (gameArea.keys) && (gameArea.keys[88]) && ((earthShip.x > 10) && (earthShip.x < 1390) && (earthShip.y > 10) && (earthShip.y < 790))){
        thrustSound.play();
        motion1(earthShip,aFactorE);
        aFactorE *= 0.99;
        earthShipAngle = earthShip.angle;
    ...
    if ((alienShip.active) && (gameArea.keys) && (gameArea.keys[79]) && ((alienShip.x > 10) && (alienShip.x < 1390) && (alienShip.y > 10) && (alienShip.y < 790))){
        thrustSound.play();
    ...
    if ((alienShip.active) && (gameArea.keys) && (gameArea.keys[76]) && ((alienShip.x > 10) && (alienShip.x < 1390) && (alienShip.y > 10) && (alienShip.y < 790))){
        thrustSound.play();
        motion1(alienShip,aFactorA);
        aFactorA *= 1.0;
        alienShipAngle = alienShip.angle;
    ...
    if ((alienShip.active) && (gameArea.keys) && (gameArea.keys[190]) && ((alienShip.x > 10) && (alienShip.x < 1390) && (alienShip.y > 10) && (alienShip.y < 790))){
        thrustSound.play();
        motion1(alienShip,aFactorA);
        aFactorA *= 0.99;
        alienShipAngle = alienShip.angle;
